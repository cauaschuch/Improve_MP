...
class Improve_MP:
    ...
    def criar_composto(composto,simetria=''):
        ...
        return Improve_MP(composto,sistema_cristalino,mpids,estrutura,internacional)
...
Nb6Ni16Si7 = Improve_MP.criar_composto('Nb6Ni16Si7',)
Improve_MP.qe_input(Nb6Ni16Si7)
